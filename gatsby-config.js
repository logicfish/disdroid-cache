    ...
    "gatsby-plugin-styled-components",
    {
      ...
      options: {
        website: {
              ...
              rssTitle: "DisDroid/IQI Purple cache #iqsec", // Title of the RSS feed
	  ...
	  // User configuration
        user: {
    	      id: "DisDroid/IQI:purple|#iqsec", // Unique identifier of the user on the website. Used for OpenGraph SEO tags
              firstName: "DisDroid/IQI", // Used for SEO
              lastName: "Purple|#iqsec", // Used for SEO
              ...
              about: "DisDroid/IQI Purple #iqsec", // User information used for the author section
